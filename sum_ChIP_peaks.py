import os   
folder = input("Enter Path of Folder Containing Necessary Files: ") #will throw an error if you don't end the path with a slash
gff_list = os.listdir(folder)
#gff files
peaks = open(input("Enter Path/Name of File Containing Peak Coordinates: "),"r")
#"C:\RhlR_project\peaks_average_coordinates.txt"
peak_table_table = []
